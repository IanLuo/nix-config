// Vendored from pi 0.85.1 examples/extensions/confirm-destructive.ts — verbatim, do not edit logic.
// Re-vendor from the pi package on upgrade; see modules/programs/pi-harness.nix.
/**
